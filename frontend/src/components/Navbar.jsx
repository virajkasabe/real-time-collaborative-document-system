...
export default function Navbar({ onSearchChange, sidebarOpen, setSidebarOpen }) {
  ...
  return (
    <header className="h-14 bg-white/85 dark:bg-[#070B14]/80 backdrop-blur-md border-b border-[#E5E7EB] dark:border-white/10 sticky top-0 z-30 px-3 sm:px-6 flex items-center justify-between transition-colors duration-300">
      ...
      <form onSubmit={handleSearchSubmit} className="hidden sm:flex flex-1 max-w-[420px] relative mx-2 lg:mx-4">
      ...
      <button
        ...
        className="sm:hidden p-1.5 rounded-lg text-[#6B7280] dark:text-[#94A3B8] hover:text-[#081B3A] dark:hover:text-[#E5E7EB] hover:bg-[#E5E7EB]/40 dark:hover:bg-[#0F172A] transition-colors duration-300"
      ...
      {mobileSearchOpen && (
        <div className="absolute top-full left-0 right-0 bg-white/95 dark:bg-[#070B14]/95 backdrop-blur-md p-3 border-b border-[#E5E7EB] dark:border-white/10 sm:hidden animate-slideDown">
      ...
      <div className="flex items-center gap-1 sm:gap-2 lg:gap-3 shrink-0">
        ...
        {/* Create Document button - Hide text on small screens */}
        <Button 
          size="md" 
          onClick={handleCreateDocument} 
          icon={Plus} 
          className="text-[13px] font-semibold px-2 sm:px-3 h-9 inline-flex items-center shadow-sm shadow-blue-500/10"
        >
        ...
        <div className="relative">
          ...
          {dropdownOpen && (
            <div className="absolute right-0 top-11 sm:top-12 w-[260px] bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 rounded-2xl shadow-2xl z-50 overflow-hidden py-2 text-left">
