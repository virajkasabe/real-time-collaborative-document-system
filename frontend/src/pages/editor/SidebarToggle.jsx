...
export default function SidebarToggle({
  ...
  const style = side === 'left'
    ? { left: collapsed ? '8px' : (isMobile ? 'calc(85vw + 8px)' : 'calc(280px + 8px)'), transition: 'left 0.3s cubic-bezier(0.4, 0, 0.2, 1)' }
    : { right: collapsed ? '8px' : (isMobile ? 'calc(85vw + 8px)' : 'calc(280px + 8px)'), transition: 'right 0.3s cubic-bezier(0.4, 0, 0.2, 1)' };
