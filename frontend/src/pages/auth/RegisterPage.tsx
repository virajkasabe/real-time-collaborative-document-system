...
export default function RegisterPage() {
  ...
  return (
    // ✅ CHANGED: h-screen overflow-hidden → min-h-screen overflow-y-auto
    // ✅ CHANGED: p-4 md:p-6 → p-3 sm:p-4 md:p-6
    <div className="min-h-screen w-full flex items-center justify-center bg-[#EEF2F7] dark:bg-[#070B14] p-3 sm:p-4 md:p-6 font-sans select-none">
      
      {/* ✅ CHANGED: h-[94vh] max-h-[860px] overflow-hidden → min-h-0 overflow-y-auto on mobile */}
      <div className="w-full max-w-5xl flex flex-col md:flex-row md:h-[94vh] md:max-h-[860px] md:overflow-hidden overflow-y-auto rounded-2xl shadow-xl bg-white dark:bg-[#0F172A]/95">
        
        {/* LEFT PANEL — unchanged, still hidden on mobile */}
        <div className="hidden md:flex w-[45%] flex-col justify-between p-8 bg-gradient-to-br from-[#D6E8FF] to-[#C2DBFF] dark:from-[#131B2E] dark:to-[#0A0D18] relative overflow-hidden self-stretch border-r border-slate-200/40 dark:border-slate-800/40">
          ...
          <div className="relative flex justify-center items-end mt-2 pt-2 max-h-[180px] overflow-hidden z-10 flex-1">
            ...
            <div className="absolute bottom-4 left-[10%] bg-white/95 backdrop-blur-sm px-2 py-1 rounded-xl shadow-md border border-slate-200/50 flex items-center gap-1.5 z-20 animate-bounce" style={{ animationDuration: '3.8s' }}>
              <div className="w-4.5 h-4.5 rounded-full bg-amber-400 text-white font-bold text-[9px] flex items-center justify-center shadow-inner aspect-square px-1">E</div>
            ...
            <div className="absolute top-1/4 right-[12%] bg-white/95 backdrop-blur-sm px-2 py-1 rounded-xl shadow-md border border-slate-200/50 flex items-center gap-1.5 z-20 animate-bounce" style={{ animationDuration: '4.2s' }}>
              <div className="w-4.5 h-4.5 rounded-full bg-emerald-500 text-white font-bold text-[9px] flex items-center justify-center shadow-inner aspect-square px-1">C</div>
            ...
            <div className="absolute bottom-5 right-[12%] bg-white/95 backdrop-blur-sm px-2 py-1 rounded-xl shadow-md border border-slate-200/50 flex items-center gap-1.5 z-20 animate-bounce" style={{ animationDuration: '3.5s' }}>
              <div className="w-4.5 h-4.5 rounded-full bg-purple-500 text-white font-bold text-[9px] flex items-center justify-center shadow-inner aspect-square px-1">V</div>
        ...
        <div className="w-full md:w-[55%] bg-white dark:bg-[#0E1524] flex flex-col justify-center p-4 sm:p-6 relative overflow-y-auto self-stretch">
          ...
          {/* ✅ CHANGED: max-w-[360px] → max-w-[360px] w-full (already fine, added py-4 for mobile breathing room) */}
          <div className="w-full max-w-[360px] mx-auto flex flex-col justify-center py-4 md:py-0 md:h-full overflow-hidden select-text">
            
            {/* ✅ ADDED: logo visible only on mobile (md:hidden) since left panel is hidden on mobile */}
            ...
            <form onSubmit={handleRegister} className="space-y-2 shrink-0">
              ...
              <div className="space-y-1 text-left">
                ...
                {errors.fullName && <p className="text-red-500 text-[11px] font-semibold mt-0.5">{errors.fullName}</p>}
              </div>
              ...
              <div className="space-y-1 text-left">
                ...
                {errors.email && <p className="text-red-500 text-[11px] font-semibold mt-0.5">{errors.email}</p>}
              </div>
              ...
              <div className="space-y-1 text-left">
                ...
                {errors.password && <p className="text-red-500 text-[11px] font-semibold mt-0.5">{errors.password}</p>}
              </div>
              ...
              <div className="space-y-1 text-left">
                ...
                {errors.confirmPassword && <p className="text-red-500 text-[11px] font-semibold mt-0.5">{errors.confirmPassword}</p>}
              </div>
              ...
              <div className="flex items-start gap-2.5 my-1 py-0 text-left">
                ...
                <label htmlFor="agreedToTerms" className="text-xs text-slate-500 dark:text-slate-400 cursor-pointer select-none leading-normal">
                  I agree to the{' '}
                  <Link to="/terms" className="text-blue-600 dark:text-blue-400 hover:underline font-semibold">Terms of Service</Link>{' '}
                  and{' '}
                  <Link to="/privacy" className="text-blue-600 dark:text-blue-400 hover:underline font-semibold">Privacy Policy</Link>
                </label>
              </div>
              {errors.agreedToTerms && <p className="text-red-500 text-[11px] font-semibold mt-0.5">{errors.agreedToTerms}</p>}
              ...
              <div className="flex items-center gap-3 py-1">
                ...
                <span className="text-slate-400 dark:text-slate-500 text-xs font-semibold tracking-wider whitespace-nowrap">OR CONTINUE WITH</span>
                <div className="h-[1px] bg-slate-200 dark:bg-slate-800/80 flex-1"></div>
              </div>
